...
const renderProjects = (parentGrid) => {
  projectList.forEach((project) => {
    ...
    liveBtn.href = live;
    liveBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    sourceBtn.innerHTML = `<svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    linksContainer.append(liveBtn, sourceBtn);

    projectContainer.append(linksContainer);
